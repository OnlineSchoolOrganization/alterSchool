        ...
        <div class="flex flex-col gap-5">
            ...
            <div class="flex justify-between">
                <div>
                    ...
                    <router-link class="w-full h-full flex justify-center items-center py-2 px-4 rounded-md text-sm cursor-pointer transition-colors bg-[color-mix(in_oklab,var(--color-slate-800)_50%,transparent)] text-zinc-100 border-2 border-slate-700" v-else to="/student/dashboard">
                        Acasă
                    </router-link>
                </div>
                <div>
